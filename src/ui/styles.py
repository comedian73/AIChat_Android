...
class AppStyles:
    ...
    MESSAGE_INPUT = {
        "width": 220,                        # Ширина поля ввода в пикселях
        "height": 50,                        # Высота поля ввода в пикселях
        "multiline": True,                  # Запрет многострочного ввода
    ...
    MODEL_SEARCH_FIELD = {
        "width": 360,                        # Ширина поля в пикселях
        "border_radius": 8,                  # Радиус скругления углов
    ...
    def set_window_size(page: ft.Page):
        ...
        """
        page.window.width = 360              # Фиксированная ширина окна
        page.window.height = 640            # Фиксированная высота окна
        page.window.resizable = False        # Запрет изменения размера пользователем
        page.window.full_screen = True       # Приложение во весь экран
